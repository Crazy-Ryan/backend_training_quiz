...
public class Application {
    ...
    private static void handle(String choice) {
        ...
        if (choice.equals("1")) {
            ...
            int[] timeRes = calPriceInfo();
            System.out.format("已为您取到车牌号为%s的车辆, 您的停车时间为%s小时，停车费用为%s元，很高兴为您服务，祝您生活愉快!\n", car,timeRes[0], timeRes[1]);
        }
    }

    private static int[] calPriceInfo() {
        return parkingService.calTimePrice();
    }
